    ...
    <div className='admin-home-container'>
     <div className='w-full h-40  flex'> 
      <div className='w-[58%] h-full rounded shadow-xl flex items-center p-5'>
        <h1 className=' text-5xl font-extrabold text-[#105daa] uppercase'>{greeting}</h1>
      </div> 
